  ...
  function App() {
      ...
      const maxIndex = Math.ceil(gridItems.length / itemsPerPage) - 1;
      ...
      const handleNext = () => {
        if (currentIndex < gridItems.length - itemsPerPage) {
    ...
    return (
            ...
            <div className='comment-form'>
              ...
              <div className='commenttxt-form'>
                ...
                className='textarea'
                  ...
                  <div className="g-recaptcha" data-sitekey="6LeVXckqAAAAAITWio63KvMPp_WY-JtiXJdLNNct"></div>
      ...
      <div className='bna-container'>
        <div className='bna-title'>
          <h2 className='bna-title-text'>conoce algunos de los avances de nuestros pacientes</h2>
        </div>
