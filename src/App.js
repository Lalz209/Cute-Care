...
function App() {
    ...
    }, [currentIndex, itemsPerPage, itemWidth]);
    ...
    <div className="App">
      ...
      <div className='grid-container'>
        <div className='nav-btns'>
          <button className='nav-btn-left' onClick={handlePrev}> <img className='btn-img' src='felcha iz.png'></img> </button>
        </div>
        <div className='grid-wrapper' style={{ width: `${itemsPerPage * itemWidth}px` }}>
          <div className='grid'>
            {visibleItems.map((src, index) => (
              <div className='grid-item' key={index}>
                <img className='grid-img' src={src} alt='service img' />
              </div>
            ))}
          </div>
        </div>
        <div className='nav-btns'>
          <button className='nav-btn-right' onClick={handleNext}> <img className='btn-img' src='flecha de.png'></img> </button>
        </div>
      </div>
